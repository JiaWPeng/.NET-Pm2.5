            ...
            <tr>
                ...
                <td class="auto-style4" style="text-align: center">
                    <table class="auto-style5">
                        <tr>
                            <td colspan="2">
                                <asp:Image ID="Image6" runat="server" Height="129px" ImageUrl="~/image/管理员登录.png" Width="306px" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">&nbsp;</td>
                        ...
                        <tr>
                            <td class="auto-style7" colspan="2">&nbsp;<asp:ImageButton ID="ImageButton1" runat="server" Height="42px" ImageUrl="~/image/登录.png" Width="305px" OnClick="ImageButton1_Click" />
                                <br />
                                <asp:ImageButton ID="ImageButton2" runat="server" Height="42px" ImageUrl="~/image/普通登录1.png" OnClick="ImageButton2_Click" Width="305px" />
                            </td>
                        </tr>
                    </table>
                </td>
